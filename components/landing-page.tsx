...
const FloatingMentorComponent = ({ src, alt, index, rotation, className }: FloatingMentorProps) => {
        ...
        <div className="flex flex-col space-y-2 sm:space-y-4 items-center sm:items-start">
          ...
          <div className="flex space-x-4">
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                window.open('https://www.instagram.com/ratemytradingmentor?igsh=d252eGphNWR0cmJ0&utm_source=qr', '_blank', 'noopener,noreferrer');
              }}
            >
              <Image 
